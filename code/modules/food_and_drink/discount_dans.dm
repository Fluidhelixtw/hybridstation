...
/obj/item/reagent_containers/food/snacks/strudel
	...
	New()
		...
		var/i = 3
		while(i-- > 0)
			reagents.add_reagent(pick("beff","sugar","eggnog","chocolate","cleaner","luminol","poo","nicotine","mint","tea","juice_lemon","juice_lime","juice_apple","juice_cherry","guacamole","egg","sewage","uranium"), 3)
